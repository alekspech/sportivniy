...
"Glock-18 | Fade": 158000,
    ...
    "★ Talon Knife | Doppler Ruby":2224-6.47,
...
def draw_roulette():
    ...
    for idx, item in enumerate(roulette_items):
        ...
        if -rw < item_x < WIDTH:
            ...
            pygame.draw.rect(screen, BUTTON_COLOR if idx == roulette_chosen_idx else (60, 60, 75),
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEWHEEL and current_tab == "upgrade":
            ...
            max_scroll = -len(target_items_list) * 43 + 400
